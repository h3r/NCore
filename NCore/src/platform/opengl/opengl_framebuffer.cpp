...
namespace NC {
	...
	namespace Utils {
		...
		static GLenum HazelFBTextureFormatToGL(FramebufferTextureFormat format)
		{
			switch (format)
			{
				...
				default: nc_fatal(false); return 0;
			}
		}
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		if (m_color_attachment_specifications.size())
		{
			...
			for (size_t i = 0; i < m_color_attachments.size(); i++)
			{
				...
				case FramebufferTextureFormat::RGBA8:
					Utils::AttachColorTexture(m_color_attachments[i], m_specification.Samples, GL_RGBA8, GL_RGBA, m_specification.Width, m_specification.Height, i);
					break;
				case FramebufferTextureFormat::RED_INTEGER:
					Utils::AttachColorTexture(m_color_attachments[i], m_specification.Samples, GL_R32I, GL_RED_INTEGER, m_specification.Width, m_specification.Height, i);
					break;
				}
			}
		}
		...
		{
			nc_assert(m_color_attachments.size() <= 4,"");
		...
		nc_assert(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete!");
	...
	{
		nc_assert(attachmentIndex < m_color_attachments.size(),"");
